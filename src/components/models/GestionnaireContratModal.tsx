                  ...
                  <div className="md:w-2/3 p-6 overflow-y-auto max-h-[90vh]">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full">
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 mb-3">Processus et prise en charge</h3>
                          ...
                          <p className="mt-2 text-sm text-gray-700">Nous travaillons en étroite collaboration avec les différents corps de métier de la construction afin d'assurer la réussite de votre projet.</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 mb-3">Gestionnaire de contrat à coût fixe</h3>
                          <div className="space-y-2 text-sm text-gray-700">
                          ...
                          <h3 className="text-lg font-semibold text-gray-900 mt-4">Nos engagements / Valeurs ajoutées</h3>
                          <ul className="list-disc pl-4 space-y-1 text-sm text-gray-700">
